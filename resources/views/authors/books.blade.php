        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4">
                        <a href="{{ route('authors.show', $author['id']) }}" class="text-indigo-600 hover:text-indigo-900">&larr; Vissza a szerzőhöz</a>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">Ennek a szerzőnek nincsenek könyvei.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
